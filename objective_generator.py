...
clinical = pd.read_csv(r"C:/Users/aless/Documents/UniTn/FirstSemester/BiologicalDataMiningLab/clinical.tsv", header=0, sep="\t")
...
for i, row in clinical.iterrows():
  ...
  # Filter for dead and alive > 5years
...
objective.to_csv(r"C:/Users/aless/Documents/UniTn/FirstSemester/BiologicalDataMiningLab/objective.tsv", sep="\t")
